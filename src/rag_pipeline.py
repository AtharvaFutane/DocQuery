...
def _get_groq_llm(temperature: float = 0.1):
    """Create a Groq LLM instance via OpenAI-compatible API."""
...
class EnhancedRAGChain:
    ...
    Uses Groq LLM to determine if a query is financial-document-related before performing RAG search.
    """
...
Classification:"""
    ...
    def __init__(self):
        self.llm = _get_groq_llm(temperature=0.1)
